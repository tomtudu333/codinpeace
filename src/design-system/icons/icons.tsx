...
export const iconComponents: Record<string, IconComponent> = {
  ...
  Database: ({ size }) => (
    <S size={size}>
      ...
      <path d="M2 4v3c0 1.4 2.7 2.5 6 2.5s6-1.1 6-2.5V4" />
      <path d="M2 7v3c0 1.4 2.7 2.5 6 2.5s6-1.1 6-2.5V7" />
    </S>
  ),
  API: ({ size }) => (
    <S size={size}>
      <path d="M4 5l-2 3 2 3M12 5l2 3-2 3M7 3l2 10" />
    </S>
  ),
  Function: ({ size }) => (
    <S size={size}>
      <path d="M10 3H7a2 2 0 00-2 2v2a2 2 0 01-2 2 2 2 0 012 2v2a2 2 0 002 2h3" />
      <path d="M6 8h5" />
    </S>
  ),
  Loop: ({ size }) => (
    <S size={size}>
      ...
      <path d="M2 10a5 5 0 015-5h7" />
      <path d="M4 12l-2-2 2-2" />
      <path d="M14 6a5 5 0 01-5 5H2" />
    </S>
  ),
  If: ({ size }) => (
    <S size={size}>
      <path d="M3 3v10h4a4 4 0 000-8H3z" />
      <path d="M9 7l2 4 2-4" />
    </S>
  ),
  Security: ({ size }) => (
    <S size={size}>
      <path d="M8 1L2 3v4.5c0 4.2 2.6 7.5 6 8.5 3.4-1 6-4.3 6-8.5V3L8 1z" />
      <path d="M6.5 8.5l1.5 1.5 3-3" />
    </S>
  ),
  Cache: ({ size }) => (
    <S size={size}>
  ...
  Network: ({ size }) => (
    <S size={size}>
      ...
      <path d="M8 5v2M6 9l-2 2M10 9l2 2" />
      <path d="M8 7a3 3 0 00-3 3" />
  ...
  Cpu: ({ size }) => (
    <S size={size}>
      ...
      <path d="M8 1v2.5M8 12.5V15M1 8h2.5M12.5 8H15M3 3l1.5 1.5M11.5 11.5L13 13M3 13l1.5-1.5M11.5 4.5L13 3" />
  ...
  Memory: ({ size }) => (
    <S size={size}>
      ...
      <path d="M4.5 4.5V2M7.5 4.5V2M10.5 4.5V2" />
      <path d="M4.5 14v-2.5M7.5 14v-2.5M10.5 14v-2.5" />
      <path d="M3 7.5h.5M5 7.5h.5M7 7.5h.5M9 7.5h.5M11 7.5h.5" />
    </S>
  ),
  ArrowUp: ({ size }) => (
    <S size={size}>
  ...
  Zap: ({ size }) => (
    <S size={size}>
      <path d="M8.5 1l-4 7h4l-1 7 5-8h-4l1-6z" />
    </S>
  ),
  Globe: ({ size }) => (
    <S size={size}>
      <circle cx="8" cy="8" r="6" />
      <path d="M2 8h12M8 2a9.5 9.5 0 010 12A9.5 9.5 0 018 2z" />
    </S>
  ),
  Heart: ({ size }) => (
    <S size={size}>
      <path d="M8 13.5l-5.5-5a3.5 3.5 0 015-5l.5.5.5-.5a3.5 3.5 0 015 5L8 13.5z" />
    </S>
  ),
  Bell: ({ size }) => (
    <S size={size}>
      <path d="M4 9.5V6a4 4 0 118 0v3.5l1.5 2h-11L4 9.5z" />
  ...
  Hash: ({ size }) => (
    <S size={size}>
      <path d="M5.5 2l-1 12M11.5 2l-1 12M2 5.5h12M2 10.5h12" />
    </S>
  ),
};
