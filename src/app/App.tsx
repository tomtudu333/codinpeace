...
const AppContent: React.FC = () => {
  ...
  const commands: CommandItem[] = [
    ...
    { id: 'show-info', label: 'Show System Info', description: 'Display system information toast', icon: 'Info', onExecute: () => addToast('CodinPeace v0.1.0 | Rendering: Canvas 2D | Theme: Dark', 'info') },
  ];
